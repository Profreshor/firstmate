...
- **A visible crew** - every crewmate works in its own tmux window, Herdr tab or configured crew pane, or an experimental Zellij tab, experimental cmux workspace, or experimental Orca terminal you can watch or type into; the first mate reconciles.
